...
export default function TranslationPopup({ isOpen, onClose, translation, onSaveWord }: TranslationPopupProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center" onClick={onClose}>
      <div className="bg-white rounded-2xl p-12 max-w-4xl mx-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-3xl font-semibold text-text-primary">Translation</h3>
        ...
        <div className="space-y-8">
          <div className="text-center">
            <div className="text-8xl font-bold text-text-primary mb-8">{translation.character}</div>
            <div className="text-4xl text-brand-primary mb-6">{translation.pinyin}</div>
            <div className="text-3xl text-text-secondary">{translation.english}</div>
          </div>
