...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <ModernNav currentPage="/" />
      <div className="max-w-screen-xl mx-auto px-6 pt-6 pb-12">
        {/* User Progress Header - Airbnb Style */}
        {userProfile && (
        <div className="modern-card p-8 mb-8 bg-gradient-to-br from-green-500/10 to-emerald-500/10">
          ...
          <div className="relative w-80 h-64 mx-auto mb-8">
            ...
            <div className="relative z-10 flex items-center justify-center h-full">
              <img src="/flowlingo-dolphin-mascot.svg" alt="FlowLingo Mascot" className="w-56 h-56 drop-shadow-xl animate-float" />
            </div>
